...
def _get_metal_kernel():
    ...
    if _metal_kernel is None:
        try:
            ...
            hub_kernel = get_kernel("kernels-community/mlx-quantization-metal-kernels", version=1)
            ...
            logger.info(
                f"Hub kernel 'kernels-community/mlx-quantization-metal-kernels' unavailable ({e}); "
